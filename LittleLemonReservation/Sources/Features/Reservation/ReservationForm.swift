...
struct ReservationForm: View {
    ...
    var body: some View {
        VStack {
            ...
            }.alert("Invalid reservation", isPresented: $showFormInvalidMessage) {
    ...
    private func validateForm() {
        ...
        let phoneIsValid = isValid(phone: customerPhoneNumber)
        ...
        guard nameIsValid && emailIsValid && phoneIsValid
            ...
            if customerEmail.isEmpty || !emailIsValid {
            ...
            self.showFormInvalidMessage = true   // ← mejor que toggle()
            return
        }
